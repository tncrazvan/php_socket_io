...
class Sync{
  ...
  public static function update_after_offset($offset_local,$local_db,$shared_db,$my_fed){
  ...
  public static function upload_after_offset($offset_local,$local_db,$shared_db,$my_fed){
  ...
  public static function download_after_offset($offset_shared,$shared_db,$local_db,$my_fed){
  ...
  public static function getLastTmpUpdateLog($local_db){
  ...
  public static function getLastUpdateLog($local_db){
