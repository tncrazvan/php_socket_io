...
CREATE TABLE IF NOT EXISTS `test_table` (
  ...
  `action` int(1) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=296 DEFAULT CHARSET=latin1;

-- Dump dei dati della tabella shared.test_table: ~9 rows (circa)
/*!40000 ALTER TABLE `test_table` DISABLE KEYS */;
INSERT INTO `test_table` (`id`, `time`, `remote_id`, `id_fd`, `action`) VALUES
	(211, 1489143000, 1, 'unimil', 0),
	(213, 1489143000, 2, 'unimil', 0),
	(263, 1489143001, 3, 'unimil', 0),
	(286, 1489143005, 4, 'unimil', 0);
